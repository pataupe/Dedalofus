...
- **Sourcing des images** des équipements : breloques (4 rangs) et sorts (4 rangs, depuis l'import Expert/Maître α/ẞ ci-dessus, image Novice réutilisée) couverts pour ce qui existe déjà en base. Restent à faire : cubes et breuvages (toujours aucune image ni donnée), + les images des ~44 sorts et ~9 breloques repérés sans correspondance (point suivant).
- **Nouveaux sorts/breloques du Dédale pas encore en base** : repérés via les images sans correspondance (~9 breloques, ~44 sorts) — en attente des données complètes du porteur de projet.
