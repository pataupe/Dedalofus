...
- **Sourcing des images** des équipements : breloques (166, dont 14 de rang `Unique` sans image — boss probablement pas encore illustrés) et sorts (4 rangs, image Novice réutilisée) couverts pour ce qui existe déjà en base. Restent à faire : cubes et breuvages (toujours aucune image ni donnée), + les images des ~44 sorts repérés sans correspondance à l'époque de "Premières images réelles" (point suivant).
- **Nouveaux sorts pas encore en base** : repérés via des images sans correspondance (~44 sorts, voir "Premières images réelles") — en attente des données complètes du porteur de projet. (Le pendant côté breloques est résolu : les ~9 breloques alors en attente + 14 autres sont arrivées via `DEDALE - BRELOQUES_NEW.csv`, voir "Onglet Boosts breloques" ci-dessus.)
