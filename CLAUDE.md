...
- **Page "Monstres du Dédale"** (déjà en prod avant cette session, commits antérieurs : "Ajoute la page Monstres du Dédale", "Grille desktop en 3 colonnes fixes + partage Discord des fiches monstre", etc.) : **jamais documentée dans ce fichier** — trou de documentation repéré en réponse à une question du porteur de projet sur la fraîcheur de ce fichier, pas encore comblé (pas assez exploré la fonctionnalité pour écrire une entrée fiable).
